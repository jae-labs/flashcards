...
const (
	programmingLanguageAnswer = "A programming language"
	goQuestion                = "What is Go?"
)
...
func TestParseFlashcards(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "single Q&A",
			input: "Q: " + goQuestion + "\nA: " + programmingLanguageAnswer,
			expected: []map[string]string{
				{questionField: goQuestion, answerField: programmingLanguageAnswer},
			},
		},
		{
			name:  "multiple Q&A",
			...
			expected: []map[string]string{
				{questionField: goQuestion, answerField: programmingLanguageAnswer},
				{questionField: "What is Python?", answerField: "Another language"},
			},
		},
		{
			name:     "no Q&A",
		...
		},
		{
			...
			input: "Q: Question 1\nQ: Question 2\nA: Answer 2",
			expected: []map[string]string{
				{questionField: "Question 2", answerField: "Answer 2"},
			},
		},
		{
			name:  "empty lines",
			input: "Q: " + goQuestion + "\n\n\nA: A language\n\n",
			expected: []map[string]string{
				{questionField: goQuestion, answerField: "A language"},
			},
		},
		{
...
func TestGenerateQA(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		chunks := []map[string]interface{}{
			{responseField: "Q: " + goQuestion + "\nA: ", doneField: false},
			{responseField: programmingLanguageAnswer, doneField: false},
			{responseField: "\nQ: What is Python?\nA: ", doneField: false},
			{responseField: "Another language", doneField: true},
		}
