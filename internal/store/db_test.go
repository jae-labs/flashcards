...
const (
	testFileOne         = "/test/1.md"
	testFileTwo         = "/test/2.md"
	testFileThree       = "/test/3.md"
	testReviewFileOne   = "/test/file1.md"
	testReviewFileTwo   = "/test/file2.md"
	testReviewFileThree = "/test/file3.md"
	questionOneDB       = "Q1"
	questionTwoDB       = "Q2"
	questionThreeDB     = "Q3"
	answerOneDB         = "A1"
...
func TestGetFlashcardsForReview(t *testing.T) {
	...
	flashcards := []Flashcard{
		{File: testFileOne, Question: questionOneDB, Answer: answerOneDB, RevisitIn: -1},    // Due
		{File: testFileTwo, Question: questionTwoDB, Answer: answerTwo, RevisitIn: 5},       // Not due
		{File: testFileThree, Question: questionThreeDB, Answer: answerThree, RevisitIn: 0}, // Due
	}
...
func TestUpdateFlashcard(t *testing.T) {
	...
	// Insert a flashcard
	fc := Flashcard{File: testFileOne, Question: questionOneDB, Answer: answerOneDB, RevisitIn: 0}
	err := store.InsertFlashcard(fc)
	if err != nil {
		t.Fatalf("InsertFlashcard() error = %v", err)
	}
...
func TestIsFileProcessed(t *testing.T) {
	...
	fc := Flashcard{File: filePath, Question: questionOneDB, Answer: answerOneDB, RevisitIn: 0}
	err = store.InsertFlashcard(fc)
	if err != nil {
		t.Fatalf("InsertFlashcard() error = %v", err)
	}
...
func TestGetUniqueFiles(t *testing.T) {
	...
	flashcards := []Flashcard{
		{File: testReviewFileOne, Question: questionOneDB, Answer: answerOneDB, RevisitIn: 0},
		{File: testReviewFileTwo, Question: questionTwoDB, Answer: answerTwo, RevisitIn: 0},
		{File: testReviewFileOne, Question: questionThreeDB, Answer: answerThree, RevisitIn: 0}, // Duplicate file
		{File: testReviewFileThree, Question: "Q4", Answer: "A4", RevisitIn: 0},
	}
	...
	expectedFiles := []string{testReviewFileOne, testReviewFileTwo, testReviewFileThree}
...
func TestGetFlashcardsForReviewByFiles(t *testing.T) {
	...
	flashcards := []Flashcard{
		{File: testReviewFileOne, Question: questionOneDB, Answer: answerOneDB, RevisitIn: 0},    // Due, file1
		{File: testReviewFileOne, Question: questionTwoDB, Answer: answerTwo, RevisitIn: 5},      // Not due, file1
		{File: testReviewFileTwo, Question: questionThreeDB, Answer: answerThree, RevisitIn: -1}, // Due, file2
		{File: testReviewFileTwo, Question: "Q4", Answer: "A4", RevisitIn: 0},                    // Due, file2
		{File: testReviewFileThree, Question: "Q5", Answer: "A5", RevisitIn: 0},                  // Due, file3
	}
	...
	selectedFiles := []string{testReviewFileOne}
	...
	if len(cards) > 0 && cards[0].Question != questionOneDB {
		t.Errorf("Expected %s, got %s", questionOneDB, cards[0].Question)
	}

	// Test 2: Get flashcards for multiple files
	selectedFiles = []string{testReviewFileOne, testReviewFileTwo}
	cards, err = store.GetFlashcardsForReviewByFiles(selectedFiles)
	if err != nil {
		t.Fatalf("GetFlashcardsForReviewByFiles() error = %v", err)
	}
	...
	selectedFiles = []string{testReviewFileOne, testReviewFileTwo, testReviewFileThree}
	cards, err = store.GetFlashcardsForReviewByFiles(selectedFiles)
	if err != nil {
		t.Fatalf("GetFlashcardsForReviewByFiles() error = %v", err)
	}
