...
import (
	...
	"github.com/jae-labs/flashcards/internal/tui/components"
	"github.com/jae-labs/flashcards/internal/tui/keys"
	"github.com/jae-labs/flashcards/internal/tui/layout"
...
func NewAdminModel(storeRef *store.Store, flashcards []store.Flashcard) *AdminModel {
	q := textinput.New()
	q.Placeholder = questionLabel
	q.Focus()
	a := textinput.New()
	a.Placeholder = answerLabel
	r := textinput.New()
	...
	columns := []table.Column{
		{Title: "ID", Width: 6},
		{Title: questionLabel, Width: 40},
		{Title: answerLabel, Width: 30},
...
func (m *AdminModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.WindowSizeMsg:
		...
		m.table.SetColumns([]table.Column{
			...
			{Title: questionLabel, Width: questionWidth},
			{Title: answerLabel, Width: answerWidth},
