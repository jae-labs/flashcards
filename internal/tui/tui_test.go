...
import (
	...
	"github.com/jae-labs/flashcards/internal/store"
...
func TestNewAdminModel(t *testing.T) {
	...
	flashcards := []store.Flashcard{
		{ID: 1, Question: questionOne, Answer: answerOne},
	}
...
func TestAdminModelUpdate(t *testing.T) {
	...
	flashcards := []store.Flashcard{
		{ID: 1, Question: questionOne, Answer: answerOne, RevisitIn: 0},
		{ID: 2, Question: questionTwo, Answer: answerTwoTUI, RevisitIn: 5},
	}
...
func TestAdminModelHandleEditView(t *testing.T) {
	...
	model.selected = 0
	model.loadSelectedIntoForm()
	model.questionInput.SetValue("Updated " + questionOne)
...
func TestAdminModelHandleDeleteConfirm(t *testing.T) {
	...
	fc := store.Flashcard{Question: "Q2", Answer: answerTwoTUI, RevisitIn: 0, File: "test2.md"}
...
func TestAdminModelHandleBulkResetConfirm(t *testing.T) {
	...
	flashcards := []store.Flashcard{
		{ID: 1, Question: questionOne, Answer: answerOne, RevisitIn: 5},
	}
	model := NewAdminModel(s, flashcards)
...
func TestAdminModelHelpers(t *testing.T) {
	...
	model.selected = 0
	model.loadSelectedIntoForm()
	if model.questionInput.Value() != questionOne {
		t.Errorf("Question should be %q, got %q", questionOne, model.questionInput.Value())
	}
...
func TestAdminModelUpdateFlashcard(t *testing.T) {
	...
	fc := store.Flashcard{Question: questionOne, Answer: answerOne, RevisitIn: 0, File: testFileName}
	err = s.InsertFlashcard(fc)
	if err != nil {
		t.Fatalf("Failed to insert flashcard: %v", err)
	}
...
func TestAdminModelBulkResetRevisitIn(t *testing.T) {
	...
	// Insert flashcards
	fc1 := store.Flashcard{Question: questionOne, Answer: answerOne, RevisitIn: 5, File: "test1.md"}
	fc2 := store.Flashcard{Question: questionTwo, Answer: answerTwoTUI, RevisitIn: 10, File: "test2.md"}
...
func TestReviewModelNextCard(t *testing.T) {
	flashcards := []store.Flashcard{
		{ID: 1, Question: questionOne, Answer: answerOne},
		{ID: 2, Question: questionTwo, Answer: answerTwoTUI},
	}
